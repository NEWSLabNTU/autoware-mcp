...
def main():
    ...
    if not check_autoware_ready():
        print("ERROR: Autoware is not ready. Please start the planning simulation first.")
    ...
    print(f"Goal position: x={poses['goal_pose']['position']['x']:.1f}, "
    ...
    goal_reached = monitor_until_goal_reached(poses['goal_pose']['position'], timeout=300)
