...
class TestROS2Manager(unittest.TestCase):
    ...
    def test_setup_ros_env(self, mock_run, mock_get_config):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            mock_result.stdout = "ROS_DISTRO=humble\nROS_VERSION=2\nPATH=/opt/ros/humble/bin:$PATH"
    ...
    def test_initialize(self):
        ...
        async def run_test():
            with patch.object(self.manager, 'run_command') as mock_run:
                ...
                with patch.object(self.manager, 'ensure_daemon_running') as mock_daemon:
                    ...
                    mock_run.assert_called_with(["ros2", "--version"])
  ...
  Services:
        ...
        async def run_test():
            with patch.object(self.manager, 'run_command') as mock_run:
                ...
                mock_run.side_effect = [
                    {"returncode": 0, "stdout": "The daemon is not running", "stderr": ""},
                    {"returncode": 0, "stdout": "The daemon has been started", "stderr": ""}
                ]
                
                await self.manager.ensure_daemon_running()
    ...
    def test_cleanup(self):
        ...
        async def run_test():
            ...
            with patch.object(self.manager, 'stop_daemon') as mock_stop:
